...
namespace UnityStandardAssets.Utility
{
    public class WaypointCircuit2 : MonoBehaviour
    {
        ...
        {
            public WaypointCircuit2 circuit;
...
{
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof (WaypointCircuit2.WaypointList))]
    public class WaypointListDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                var circuit = property.FindPropertyRelative("circuit").objectReferenceValue as WaypointCircuit2;
