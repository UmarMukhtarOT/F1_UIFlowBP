        ...
        private void Awake() {
            ...
            if (exhaustParticles != null) {
                exhaustParticles.condition = () => {
                    if (theKart != null) {
                        //Debug.Log("exhaustParticles ready "+ !theKart.IsBoostReady());
                        return !theKart.IsBoostReady();

                    }
                    else {
                        //Debug.Log("exhaustParticles ready "+ false);
                        return false;
                    }
                };
            }
            ...
            if (exhaustBoostReadyParticles != null) {
                exhaustBoostReadyParticles.condition = () => {
                    if (theKart != null) {
                        //Debug.Log("exhaustBoostReadyParticles ready " + !theKart.IsBoostReady());
                        return theKart.IsBoostReady();
                    }
                    else {
                        //Debug.Log("exhaustBoostReadyParticles ready " + false);
                        return false;
                    }
                };
            }
            ...
            if (boostParticles != null) {
                boostParticles.condition = () => {
                    if (theKart != null) {
                        //Debug.Log("boostParticles ready " + theKart.boostReserve);
                        return theKart.boostReserve > 0;
                    }
                    else {
                        //Debug.Log("boostParticles not ready ");
                        return false;
                    }
                };
            }
