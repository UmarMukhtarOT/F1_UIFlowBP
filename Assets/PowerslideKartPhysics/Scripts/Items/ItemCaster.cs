...
namespace PowerslideKartPhysics
{
    ...
    public class ItemCaster : MonoBehaviour
    {
        ...
        Sprite sprite;
        public SpriteRenderer itemIconContainer;
